...
PRINT '============================================================';
PRINT 'NAVI HERRAMIENTAS - EXPORTAR DATOS SEGURO';
PRINT '============================================================';
...
BEGIN
    SELECT @SelectList = STRING_AGG(
        CASE
            ...
            ELSE 'TRY_CONVERT(nvarchar(max), ' + QUOTENAME(c.name) + ') AS ' + QUOTENAME(c.name)
        END,
        ', '
    ...
    BEGIN
        SET @Sql =
            N'PRINT ''============================================================'';' + CHAR(13) +
            N'PRINT ''TABLE: ' + REPLACE(QUOTENAME(@SchemaName) + N'.' + QUOTENAME(@TableName), '''', '''''') + N''';' + CHAR(13) +
